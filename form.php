...
<p>With this simple WordPress Plugin you can Add your Google Analytics Code (G-xxxxxxx) into your Header.php File without coding</p>
...
//Style Auswahl
echo '<h2 id="auswahlfeld">Activate or Deactivate your Google Analytics Code</h2>';
...
*/
if ($quickgoogleanalytics_select_show == '' || $quickgoogleanalytics_select_show == '1' || $quickgoogleanalytics_select_show == '2'){
	echo '<option selected value="" >Your Plugin dos not work anymore - upgrade to GA4</option>';
}
if ($quickgoogleanalytics_select_show == '3')
{ echo '<option selected value="3" >Activate Google Analytics 4 (G-ABCDEFGHIJ)</option>';}
else
{ echo '<option value="3" >Google Analytics 4 (G-ABCDEFGHIJ)</option>';}
	
if ($quickgoogleanalytics_select_show == '4')
{ echo '<option selected value="4" >Deactivate the GA Code integration</option>';}
else
...
/* ########################################################## */
  ...
  <hr />
  	<div class="wrap">
		...
		<p>If you need are looking for a seo plugin for your wordpress, then I recommend this plugin called "WP Smart SEO".
Download: <a href="https://de.wordpress.org/plugins/wp-smart-seo/" target="_blank">WP Smart SEO</a></p>

<p>Add a sitemap to your wordpress website with, 
Download: <a href="https://wordpress.org/plugins/simple-xml-sitemap-generator/" target="_blank">Simple XML Sitemap Generator</a></p>

all plugins work perfectly together
	</div>
  <div class="wrap">
